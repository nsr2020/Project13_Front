import { Button, FormControl, FormLabel, Input, Stack, useToast, Box, Text } from '@chakra-ui/react';
        ...
        <>
            ...
            >
                ...
                <FormControl display="flex" flexDir="column" align="center"
                    background="linear-gradient(135deg, var(--nsr-color19), var(--nsr-color20))"
                    color="var(--nsr-color1)" pos="relative">
                    ...
                    <FormLabel htmlFor="password" marginTop="var(--nsr-margin3)">Password: </FormLabel>
                    <Box position="relative" width="100%">
