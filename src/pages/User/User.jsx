        ...
        <>
            ...
            {user && (
                <Flex direction="column"
                    ...
                    <Card w="85%" minH="50svh" bgColor="#f7d792" mt="60px" pos="relative" 
                        bgImage="url(https://www.transparenttextures.com/patterns/buried.png)">
                        <CardHeader>
                            <Flex spacing='4'>
                                <Flex flex="1" alignItems='center' flexWrap='wrap' gap="80px">
                                    ...
                                    <Image pos="absolute" top="20px" right="20px" cursor="pointer"
                                    src="/assets/logOut.png" w="50px" title="LogOut"
                                    transition="all 0.5s"
